...
@interface SUP101KeyGeneratorPK : SUPAbstractStructure<SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    int64_t _batchId;
...
@end
typedef SUPObjectList SUP101KeyGeneratorPKList;

// internal methods declaration, only used by generated code.
@interface SUP101KeyGeneratorPK(internal)
