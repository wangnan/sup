...
@interface SUP101ChangeLogImpl : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData,SUPChangeLog>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (SUP101ChangeLogImpl*)load:(SUP101ChangeLogKey*)id;
/*!
  @method 
...
@end
typedef SUPObjectList SUP101ChangeLogImplList;

// internal methods declaration, only used by generated code.
@interface SUP101ChangeLogImpl(internal)
