...
@interface SUP101PackageProperties : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData, SUPAbstractPackageProperties>
{
@private
    NSString* _value;
    NSString* _key;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (SUP101PackageProperties*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList SUP101PackagePropertiesList;

// internal methods declaration, only used by generated code.
@interface SUP101PackageProperties(internal)
