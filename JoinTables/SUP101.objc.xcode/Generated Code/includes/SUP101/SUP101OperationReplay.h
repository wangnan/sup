...
@interface SUP101OperationReplay : SUPAbstractROEntity<SUPOperationReplay, SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    NSString* _component;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (SUP101OperationReplay*)load:(int64_t)id;
/*!
  @method 
...
@end
typedef SUPObjectList SUP101OperationReplayList;

// internal methods declaration, only used by generated code.
@interface SUP101OperationReplay(internal)
