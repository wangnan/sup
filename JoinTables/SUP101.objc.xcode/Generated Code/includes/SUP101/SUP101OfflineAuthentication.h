...
/*!
 @class SUP101OfflineAuthentication
...
@interface SUP101OfflineAuthentication : SUPAbstractLocalEntity<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (SUP101OfflineAuthentication*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList SUP101OfflineAuthenticationList;

// internal methods declaration, only used by generated code.
@interface SUP101OfflineAuthentication(internal)
